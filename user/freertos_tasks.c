...
{
    switch (mode) {
        case  0: Exp1_LED_Flowing();   break;
        case  1: Exp5_TrafficLight();  break;
        case  2: Exp2_KeyPolling();    break;
        case  3: Exp8_IndependentKeys(); break;
        case  4: Exp9_DIPSwitch();     break;
        case  5: Exp4_USART1_Echo();   break;
        case  6: Exp15_RS232();        break;
        case  7: Exp16_RS485();        break;
        case  8: Exp3_LightSensor();   break;
        case  9: Exp11_DHT11();        break;
        case 10: Exp12_Thermistor();   break;
        case 11: Exp13_DS18B20();      break;
        case 12: Exp17_Infrared();     break;
        case 13: Exp18_Encoder();      break;
        case 14: Exp19_DCMotorPWM();   break;
        case 15: Exp20_Servo();        break;
        case 16: Exp6_LCD12864();      break;
        case 17: Exp7_CH451();         break;
        case 18: Exp10_Relay();        break;
        case 19: Exp14_DA();           break;
